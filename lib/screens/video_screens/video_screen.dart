...
import 'package:ombre_task/screens/video_screens/bloc/video_play/video_play_bloc.dart';
import 'package:ombre_task/screens/video_screens/components/video_player.dart';
import 'package:video_player/video_player.dart';

import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:image_picker/image_picker.dart';
import 'package:ombre_task/screens/video_screens/video_confirm.dart';
        ...
        body: StreamBuilder<List?>(
          ...
          builder: (context, snapshot) {
            ...
            return PageView.builder(
              onPageChanged: (value) {
                if (value + 1 == snapshot.data?.length) {
                  videoPlayBloc.eventSink.add(StreamEvents.nextVideos);
                }
              },
